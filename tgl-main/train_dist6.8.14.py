...
python -m torch.distributed.launch --nproc_per_node=2 --nnodes=2 --node_rank=0 --master_addr="10.214.151.192" --master_port=34567 train_dist6.8.14.py --data GDELT --config config/TGN.yml --num_gpus=1

python -m torch.distributed.launch --nproc_per_node=1 --nnodes=2 --node_rank=1 --master_addr="10.214.151.192" --master_port=34567 train_dist6.8.14.py --data GDELT --config config/TGN.yml --num_gpus=1
